...
MODULE_NAME="ysg"                                                               #The python module name
...
DESCRIPTION = "A tool to remotely control the YSG signal generator device."     # A short description of the application
PYTHON_VERSION = 3                                                              #The python applications version
LICENSE = "MIT License"
REAUIRED_LIBS = []                                                              #The License that the application is distributed under
MAIN_FILES=["ysg"]                                                              #A list of python files (minus the .py extension) in the module containing the main entry point.
